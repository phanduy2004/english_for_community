...
import 'package:english_for_community/feature/admin/layout/admin_change_password_dialog.dart';
import 'package:english_for_community/feature/admin/layout/admin_dialog_shell.dart';
import 'package:english_for_community/feature/admin/layout/admin_edit_profile_dialog.dart';
...
/// Admin account hub — centered dialog (`docs/ui-ux-system/07` §4).
void showAdminAccountMenu(BuildContext context) {
  AdminDialogShell.show<void>(context, child: const AdminAccountMenuDialog());
}

class AdminAccountMenuDialog extends StatefulWidget {
  const AdminAccountMenuDialog({super.key});

  @override
  State<AdminAccountMenuDialog> createState() => _AdminAccountMenuDialogState();
}

class _AdminAccountMenuDialogState extends State<AdminAccountMenuDialog> {
  String _appVersion = '—';
        ...
        return AdminDialogShell(
          ...
          body: Column(
            ...
            children: [
              ...
              AdminDialogSectionLabel(l10n.accountAndSecurity),
              AdminDialogOptionTile(
                icon: Icons.person_outline,
                title: l10n.editProfileTitle,
                onTap: () => _closeThen(
                  (ctx) => AdminDialogShell.show(
                    ctx,
                    child: const AdminEditProfileDialog(),
                  ),
                ),
              ),
              ...
              AdminDialogOptionTile(
                ...
                onTap: () => _closeThen(
                  (ctx) => AdminDialogShell.show(
                    ctx,
                    child: const AdminChangePasswordDialog(),
                  ),
                ),
              ),
              const SizedBox(height: AppSpacing.s5),
              AdminDialogSectionLabel(l10n.generalSettings),
              AdminDialogOptionTile(
              ...
              const SizedBox(height: AppSpacing.s5),
              AdminDialogSectionLabel(l10n.teacherAccountSectionAbout),
              AdminDialogOptionTile(
  ...
  static void _showDeleteAccountDialog(BuildContext context) {
    final l10n = context.l10n;
    AdminDialogShell.show<void>(
      context,
      child: AdminDialogShell(
