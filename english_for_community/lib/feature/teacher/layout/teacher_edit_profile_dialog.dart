...
/// Edit profile in teacher dialog shell — `docs/ui-ux-system/14-teacher-dialogs.md`.
class TeacherEditProfileDialog extends StatefulWidget {
  const TeacherEditProfileDialog({super.key});

  @override
  State<TeacherEditProfileDialog> createState() => _TeacherEditProfileDialogState();
}

class _TeacherEditProfileDialogState extends State<TeacherEditProfileDialog> {
            ...
            body: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TeacherDialogSectionLabel(t.sectionPublicInfo),
                  _Field(
                  ...
                  _Field(
                    ...
                    child: TextFormField(
                      ...
                      style: TeacherWebUi.webBody(context),
                      decoration: TeacherWebUi.formInputDecoration(context, hintText: '@username'),
                      onChanged: (_) => _markDirty(),
                      validator: (v) => (v == null || v.trim().isEmpty) ? t.fieldRequired : null,
                    ),
                  ),
                  ...
                  _Field(
                    ...
                    child: TextFormField(
                      ...
                      maxLines: 3,
                      style: TeacherWebUi.webBody(context),
                      decoration: TeacherWebUi.formInputDecoration(context, hintText: t.hintBio),
                      onChanged: (_) => _markDirty(),
                    ),
                  ),
                  const SizedBox(height: AppSpacing.s6),
                  TeacherDialogSectionLabel(t.sectionPrivateDetails),
                  _Field(
                    label: t.labelGender,
                    child: Wrap(
                      spacing: 8,
                  ...
                  _Field(
                    ...
                    child: TextFormField(
                      ...
                      readOnly: true,
                      style: TeacherWebUi.webBody(context),
                      decoration: TeacherWebUi.formInputDecoration(context, hintText: t.hintSelectDate).copyWith(
                  ...
                  _Field(
                    ...
                    child: TextFormField(
                      ...
                      style: TeacherWebUi.webBody(context),
                      decoration: TeacherWebUi.formInputDecoration(context, hintText: t.hintPhoneShort),
                      onChanged: (_) => _markDirty(),
                    ),
                  ),
                  const SizedBox(height: AppSpacing.s6),
                  TeacherDialogSectionLabel(t.sectionSystemInfo),
                  _Field(
                    label: t.labelEmail,
                    child: TextFormField(
