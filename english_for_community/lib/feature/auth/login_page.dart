...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _loadAppVersion() async {
    ...
    if (!mounted) return;
    setState(() {
      _versionLabel = 'E4C · v${info.version} (${info.buildNumber})';
    });
  }
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    textAlign: TextAlign.center,
                                    style:
                                        StudentMobileUi.body(context).copyWith(
  ...
  Widget _buildVersionFooter() {
    if (_versionLabel.isEmpty) {
      return const SizedBox(height: AppSpacing.s6);
    }
    return Padding(
      padding: const EdgeInsets.only(top: AppSpacing.s3, bottom: AppSpacing.s4),
      child: Text(
        _versionLabel,
        textAlign: TextAlign.center,
