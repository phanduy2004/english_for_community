    ...
    if (context.mounted) {
      result.fold(
        ...
        (r) => ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(context.l10n.wordSavedSnackbar(widget.entry.headword))),
        ),
      );
    }
  }
  ...
  Future<void> _startLearning(BuildContext context) async {
    ...
    if (context.mounted) {
      result.fold(
        (l) => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(l.message))),
        (r) => ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(context.l10n.wordAddedToLearningQueue(widget.entry.headword))),
        ),
      );
    }
  }
