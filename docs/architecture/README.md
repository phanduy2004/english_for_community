...
| [`database/database-diagrams-uml.md`](database/database-diagrams-uml.md) | **Sơ đồ class CSDL (Mermaid)** — tổng quan + domain |
| [`database-diagrams-for-word.md`](database-diagrams-for-word.md) | Hướng dẫn export Word + bảng 32 collection |
| [`plantuml/`](plantuml/README.md) | File `.puml` tuỳ chọn (PlantText) |
...
| [`../database-design-audit.md`](../database-design-audit.md) | **Đánh giá thiết kế DB** (32 schema): điểm số, vấn đề kèm `file:dòng`, chuẩn đề xuất |
